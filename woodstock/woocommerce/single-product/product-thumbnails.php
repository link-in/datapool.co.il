...
<div class="product_thumbnails">
        <div class="swiper-container">
            <div class="swiper-wrapper">                
                ...
                $image              = get_the_post_thumbnail( $post->ID, apply_filters( 'single_product_small_thumbnail_size', 'woocommerce_thumbnail' ), array(
                    'title' => $image_title
                    ) );
                ...
                if ( $attachment_ids ) {
                    ...
                    foreach ( $attachment_ids as $attachment_id ) {
                        ...
                        $image       = wp_get_attachment_image( $attachment_id, apply_filters( 'single_product_small_thumbnail_size', 'woocommerce_thumbnail' ) );
            ...
            <?php 
                ...
                $thumbnail_swiper_height = (90/($thumbnail[1]/$thumbnail[2])) * $number_of_thumbs + (($number_of_thumbs - 1) * 20 ); // 20 is the padding between thumbs
